...
! function (t, e) {
    ...
    class Ie extends R {
        ...
        _getConfig(t) {
            return t = {
                ...Ne, ...U.getDataAttributes(this._element), ...t
            }, d("modal", t, Se), t
        }
        _showElement(e) {
    ...
    class Me extends R {
        ...
        _getConfig(t) {
            return t = {
                ...je, ...U.getDataAttributes(this._element), ...
                    "object" == typeof t ? t : {}
            }, d("offcanvas", t, Pe), t
        }
        _initializeBackDrop() {
    ...
    const Ye = new RegExp("(^|\\s)bs-popover\\S+", "g"),
        ...
        Ge = {
            ...Xe.DefaultType, content: "(string|element|function)"
        },
        Ze = {
    ...
    class ii extends R {
        ...
        _getConfig(t) {
            if ("string" != typeof (t = {
                ...ti, ...U.getDataAttributes(this._element), ...
                    "object" == typeof t && t ? t : {}
            }).target && a(t.target)) {
                let {
                    id: i
    ...
    class ri extends R {
        ...
        _getConfig(t) {
            return t = {
                ...oi, ...U.getDataAttributes(this._element), ...
                    "object" == typeof t && t ? t : {}
